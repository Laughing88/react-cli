# Laughing 快速搭建react-cli
# npm init 配置package.json文件
# npm i react --save 安装 react
# npm i react-dom --save 安装 react-dom
# npm i react-router-dom --save 安装路由 vue-router
